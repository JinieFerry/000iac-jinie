...
spec:
  ...
  resources:
    requests:
      storage: 1Gi # 백엔드 데이터 저장용 2GB 할당:1로 주기
...
```bash
# 할당된 PV 이름 확인
kubectl get pvc back-pvc -n wb_prod -o jsonpath='{.spec.volumeName}' #파일 하나 빠져서 이름 안 뜸 #23 파이썬 연결 새로업로드 함
