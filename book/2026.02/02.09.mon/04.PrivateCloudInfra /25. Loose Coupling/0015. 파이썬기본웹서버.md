...
spec:
  ...
  ports:
    - protocol: TCP
      port: 80
      targetPort: 8000
      nodePort: 31000 #33000까지만 열엇으니까 고침
...
* **주소:** `http://<Worker-Node-IP>:38080` #함정
* 192.168.115.251:31000을 크롬에 검색
* <img width="736" height="667" alt="image" src="https://github.com/user-attachments/assets/580ddb32-3386-4f65-b081-6b25b07c7b74" />
...
```bash
kubectl port-forward svc/py-service -n wb_prod 8888:80 #서비스 포트여서 80임 브라우저 외부 접속 안됨
