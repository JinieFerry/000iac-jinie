...
spec:
  ...
  ports:
    - protocol: TCP
      port: 8000
      targetPort: 8000
      nodePort: 30888  # 엔진엑스(30080)와 충돌하지 않도록 설정 #이전에 30088써서 안된 듯
...
```
   ...
   k delete deployments.apps fastapi-web 
   k delete deployments.apps fastapi-app 
   k get deployments.apps 
   k get svc
   k delete svc fastapi-service 
   k delete svc fastapi-svc
   k get svc
   k get pod
   k get pvc
```
